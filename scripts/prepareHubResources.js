 ...
 *
 * Downloads the AURAHub index.json and all extension zip packages
...
const BASE_URLS = [
  `https://raw.githubusercontent.com/iOfficeAI/AURAHub/${process.env.AIONUI_HUB_TAG || DEFAULT_TAG}/`,
  `https://cdn.jsdelivr.net/gh/iOfficeAI/AURAHub@${process.env.AIONUI_HUB_TAG || DEFAULT_TAG}/`,
];
