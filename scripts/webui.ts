 ...
 * work on hosts that never installed AURA.app, and its default work dir must
 ...
 * `~/Library/Application Support/AURA-Dev/aura` so CLI tools (claude,
...
async function main(): Promise<void> {
  ...
  // This keeps `bun run webui` fully self-contained on hosts without AURA.app.
