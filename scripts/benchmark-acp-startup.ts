...
function getLogFilePath(): string {
  ...
  // Dev mode uses "AURA-Dev", production uses "AURA"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'AURA-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'AURA', `${today}.log`);
