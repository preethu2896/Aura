...
AURA is a multi-process Electron app with three core layers: **renderer**, **main process**, and **preload/shared**.
...
├── base/           # UI primitives — AURAModal, AURASelect, FlexFullContainer, etc.
