<p align="center">
  <img src="../../resources/aura-banner-1.png" alt="AURA - Спільна робота з AI-агентами" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/iOfficeAI/AURA?style=flat-square&color=32CD32" alt="Версія">
  &nbsp;
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <strong>Українська</strong> | <a href="https://github.com/iOfficeAI/AURA" target="_blank">Офіційний сайт</a>
</p>

<p align="center">
  <strong>💬 Спільнота:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-14.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/AURAUI" target="_blank">Twitter</a>
</p>
...
[🤔 Чому варто обрати AURA?](#-чому-варто-обрати-aura-замість-claude-cowork) ·
...
**AURA — це більше, ніж просто чат-клієнт.** Це платформа для спільної роботи (Cowork), де AI-агенти працюють пліч-о-пліч із вами на вашому комп'ютері: читають файли, пишуть код, шукають в інтернеті та автоматизують завдання. Ви бачите все, що робить агент, і завжди зберігаєте контроль.

|                                    | Традиційні AI чат-клієнти | **AURA (Cowork)**                                                                                                    |
| :--------------------------------- | :------------------------ | :------------------------------------------------------------------------------------------------------------------- |
...
AURA постачається з повноцінним рушієм AI-агентів. На відміну від інструментів, що вимагають окремого встановлення CLI-агентів, **AURA працює одразу після встановлення**.
...
Якщо ви вже використовуєте Claude Code, Codex, Hermes Agent або OpenClaw, AURA автоматично виявить їх і дозволить працювати з усіма ними разом із вбудованим агентом.

**Підтримувані агенти:** Вбудований агент • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • AURA CLI (aionrs, Rust-бекенд-сервіс, що постачається з AURA) • Snow CLI • Hermes Agent • Cursor Agent та інші
...
- **Паралельне виконання кількох агентів** — Leader ділить завдання на підзадачі і делегує паралельно працюючим Teammate-агентам; кожен Teammate використовує свою модель через ACP (Agent Communication Protocol, шар координації мульти-агентності AURA), Gemini або Aionrs
- **Оркестрація Leader** — Leader призначає, відстежує та агрегує результати; підтримувані бекенди: Claude Code, Codex, Hermes Agent, Gemini, Snow CLI, AURA CLI
...
- **Підтримувані бекенди** — Claude Code, Codex, Gemini, Snow CLI, AURA CLI (aionrs); інші ACP-бекенди з `mcpCapabilities.stdio` підтримуються автоматично
...
Інші додатки дають лише вікно чату. **AURA дає повноцінного агента для спільної роботи.**
...
Ті ж самі можливості — читання/запис файлів, веб-пошук, генерація зображень — незалежно від того, яка модель використовується. AURA підтримує **30+ AI-платформ**.
...
- **Трирівневі навички** — вбудовані навички (поставляються з AURA), власні навички (ваші особисті) та Extension-навички (від сторонніх розширень); вмикайте/вимикайте для кожної розмови з індикатором навичок
...
**Навички**: навички з трьох джерел — вбудовані (поставляються з AURA), власні (ваші особисті) та Extension (через Extension SDK). Вбудовані: `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` та інші.
...
- **Режим без сну** — AURA автоматично запобігає переходу системи у сплячий режим, поки активні завдання, та визначає пропущені тригери після пробудження
...
<p align="center">
  <img src="../../resources/aura sort file 2.gif" alt="Керування файлами" width="800">
</p>

---

## 🤔 Чому варто обрати AURA замість Claude Cowork?

AURA — це **безкоштовний Multi-AI Agent десктоп**. На відміну від Claude Cowork, який працює лише на macOS і обмежений лише Claude, AURA — це версія з підтримкою всіх моделей та платформ.
...
- [GitHub Discussions](https://github.com/iOfficeAI/AURA/discussions) — діліться ідеями
- [Повідомити про проблему](https://github.com/iOfficeAI/AURA/issues) — баги та запити функцій
...
Локальна розробка AURA використовує два репозиторії: AURA для Electron-фронтенду та AionCore для локального backend. Повні інструкції для macOS, Linux і Windows наведені в [Development Guide](../contributing/development.md).
