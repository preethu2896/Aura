...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <strong>Türkçe</strong> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://github.com/iOfficeAI/AURA" target="_blank">Resmi Web Sitesi</a>
</p>

<p align="center">
  <strong>💬 Topluluk:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-14.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/AURAUI" target="_blank">Twitter</a>
</p>
...
[🤔 Neden AURA'yi Seçmelisiniz?](#-neden-aura-claude-cowork-yerine) ·
...
**AURA sadece bir sohbet istemcisi değil.** AI Agents'ın bilgisayarınızda sizinle çalıştığı bir Cowork platformudur — dosya okuma, kod yazma, web'de gezinme ve görevleri otomatikleştirme. Agent'ın yaptığı her şeyi görürsünüz ve her zaman kontrol sizdedir.

|                                        | Geleneksel AI Sohbet İstemcileri | **AURA (Cowork)**                                                                                                               |
| :------------------------------------- | :------------------------------- | :------------------------------------------------------------------------------------------------------------------------------ |
...
AURA tam bir AI Agent motoru ile birlikte gelir. CLI Agent'ları ayrı olarak kurmanızı gerektiren araçların aksine, **AURA kurduğunuz anda çalışır**.
...
Zaten Claude Code, Codex, Hermes Agent veya OpenClaw kullanıyorsanız, AURA bunları otomatik olarak algılar ve hepsiyle Cowork yapmanıza izin verir — yerleşik Agent ile birlikte.

**Desteklenen Agents:** Yerleşik Agent (sıfır kurulum) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • AURA CLI (aionrs, AURA ile birlikte dağıtılan Rust tabanlı arka uç servisi) • Snow CLI • Hermes Agent • Cursor Agent ve daha fazlası
...
- **Paralel çoklu agent çalıştırma** — Leader görevleri alt görevlere bölerek paralel çalışan Teammate Agent'lara devreder; her Teammate ACP (Agent Communication Protocol, AURA'nin çoklu agent koordinasyon katmanı), Gemini veya Aionrs aracılığıyla kendi modelini kullanır
- **Leader orkestrasyonu** — Leader atar, izler ve sonuçları toplar; desteklenen arka uçlar: Claude Code, Codex, Hermes Agent, Gemini, Snow CLI ve AURA CLI
...
- **Desteklenen arka uçlar** — Claude Code, Codex, Gemini, Snow CLI, AURA CLI (aionrs); `mcpCapabilities.stdio` ile diğer ACP arka uçları otomatik desteklenir
...
Diğer AI uygulamaları size API anahtarınızla bir sohbet kutusu verir. **AURA size tam bir Cowork Agent verir.**
...
Aynı Agent yetenekleri — dosya okuma/yazma, web arama, görüntü oluşturma, araç kullanımı — hangi modelin güç verdiğine bakılmaksızın. AURA bulut hizmetleri ve yerel dağıtımlar dahil **30+ AI platformunu** destekler.
...
AURA ayrıca [NewAPI](https://github.com/QuantumNous/new-api) ağ geçidi hizmetini destekler — çeşitli LLM'leri toplayan ve dağıtan birleşik bir AI model merkezi. Çeşitli görev gereksinimlerini karşılamak için aynı arayüzde farklı modeller arasında esnek bir şekilde geçiş yapın.
...
- **Üç katmanlı Beceriler** — Yerleşik beceriler (AURA ile birlikte gelen), özel beceriler (kendinizinkiler) ve Extension becerileri (üçüncü taraf uzantılar tarafından katkıda bulunulan); beceri göstergesi ile konuşma başına etkinleştirin/devre dışı bırakın
...
AURA önceden tanımlanmış yeteneklere sahip **21 profesyonel asistan** içerir, özel beceriler aracılığıyla genişletilebilir:
...
_7/24 AI asistanınız — AURA'ye herhangi bir cihazdan, her yerden erişin._
...
> **Kurulum:** AURA Ayarları → WebUI Ayarları → Kanal, Bot Token'ı yapılandırın.
...
> [Uzaktan İnternet Erişimi Öğreticisi](https://github.com/iOfficeAI/AURA/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Uyanık kal** — AURA görevler aktifken sistem uyku moduna geçmeyi otomatik olarak önler ve uyandıktan sonra kaçırılan tetikleyicileri algılar
...
> [Görüntü oluşturma modeli yapılandırma kılavuzu](https://github.com/iOfficeAI/AURA/wiki/AURA-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Neden AURA, Claude Cowork Yerine?
...
AURA **ücretsiz ve açık kaynaklı bir Çoklu AI Agent Masaüstü** uygulamasıdır. Sadece macOS'ta çalışan ve Claude'ye kilitli Claude Cowork ile karşılaştırıldığında, AURA tam model, çapraz platform geliştirilmiş versiyonudur.

| Boyut           | Claude Cowork | AURA                                              |
| :-------------- | :------------ | :------------------------------------------------ |
...
C: <strong>Hayır.</strong> AURA kurulumdan hemen sonra çalışan yerleşik bir AI Agent'a sahiptir. Başlamak için herhangi bir API anahtarı girmeniz yeterli. Ayrıca Claude Code veya Gemini CLI gibi CLI araçlarınız da kuruluysa, AURA bunları otomatik olarak algılayacak ve daha fazla yetenek için entegre edecektir.
</details>

<details>
<summary><strong>S: AURA ile ne yapabilirim?</strong></summary>
C: AURA sizin <strong>özel Cowork çalışma alanınızdır</strong>. Yerleşik Agent klasörleri toplu olarak organize edebilir, Excel verilerini işleyebilir, belgeler oluşturabilir, web'de arama yapabilir ve görüntüler oluşturabilir. Çoklu Agent Modu ile aynı arayüz üzerinden Claude Code, Codex ve diğer güçlü CLI Agent'larından da yararlanabilirsiniz.
</details>

<details>
<summary><strong>S: Ücretsiz mi?</strong></summary>
C: AURA tamamen ücretsiz ve açık kaynaklıdır. Yalnızca seçtiğiniz sağlayıcının API kullanımı için ödeme yaparsınız ve tercih ettiğiniz herhangi bir sağlayıcıdan API anahtarları kullanabilirsiniz.
</details>
...
## İnsanların AURA'yi Nasıl Kullandığını Görün
...
> **AURA hakkında bir video yaptınız mı?** [X'te bize bildirin](https://x.com/AURA) ve burada öne çıkaralım!
...
- [📖 Tam Kurulum Kılavuzu](https://github.com/iOfficeAI/AURA/wiki/Getting-Started) — İndirmeden yapılandırmaya kadar detaylı adımlar
- [⚙️ LLM Yapılandırma Kılavuzu](https://github.com/iOfficeAI/AURA/wiki/LLM-Configuration) — Çoklu platform AI model yapılandırması
- [🤖 Çoklu Agent Modu Kurulumu](https://github.com/iOfficeAI/AURA/wiki/ACP-Setup) — Terminal AI Agent'larını entegre edin
- [🔌 MCP Araç Yapılandırması](https://github.com/iOfficeAI/AURA/wiki/MCP-Configuration-Guide) — Model Context Protocol sunucu kurulumu
- [🌐 WebUI Yapılandırma Kılavuzu](https://github.com/iOfficeAI/AURA/wiki/WebUI-Configuration-Guide) — Tam WebUI kurulum ve yapılandırma öğreticisi

**🎯 Kullanım Senaryoları**

- [📁 Dosya Yönetimi](https://github.com/iOfficeAI/AURA/wiki/file-management) — Akıllı dosya organizasyonu
- [📊 Excel İşleme](https://github.com/iOfficeAI/AURA/wiki/excel-processing) — AI destekli veri işleme
- [🎨 Görüntü Oluşturma](https://github.com/iOfficeAI/AURA/wiki/AURA-Image-Generation-Tool-Model-Configuration-Guide) — AI görüntü oluşturma
- [📚 Daha Fazla Kullanım Senaryosu](https://github.com/iOfficeAI/AURA/wiki/Use-Cases-Overview)

**❓ Destek ve Yardım**

- [❓ SSS](https://github.com/iOfficeAI/AURA/wiki/FAQ) — Sorular ve sorun giderme
- [🔧 Yapılandırma ve Kullanım Öğreticileri](https://github.com/iOfficeAI/AURA/wiki/Configuration-Guides) — Tam yapılandırma dokümantasyonu
...
- [GitHub Discussions](https://github.com/iOfficeAI/AURA/discussions) — fikirleri paylaşın ve ipuçları alışverişi yapın
- [Sorun Bildir](https://github.com/iOfficeAI/AURA/issues) — hatalar ve özellik istekleri
- [Sürüm Güncellemeleri](https://github.com/iOfficeAI/AURA/releases) — en son sürümü alın
...
AURA yerel geliştirme iki depo kullanır: Electron frontend için AURA ve yerel backend için AionCore. macOS, Linux ve Windows için tam kurulum adımları için [Development Guide](../contributing/development.md) belgesine bakın.
...
[Hata Bildir](https://github.com/iOfficeAI/AURA/issues) · [Özellik İste](https://github.com/iOfficeAI/AURA/issues)
