...
<p align="center">
  <strong>💬 Community:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="./resources/wx-14.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/AURAUI" target="_blank">Twitter</a>
</p>
...
[Why Choose AURA?](#-why-choose-aura-over-claude-cowork) ·
...
AURA ships with a complete AI agent engine. Unlike tools that require you to install CLI agents separately, **AURA works the moment you install it**.
...
If you already use Claude Code, Codex, Hermes Agent, or OpenClaw, AURA auto-detects them and lets you Cowork with all of them — alongside the built-in agent.

**Supported Agents:** Built-in Agent (zero setup) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • AURA CLI (aionrs, the Rust-based backend service shipped with AURA) • Snow CLI • Hermes Agent • Cursor Agent and more
...
- **Parallel multi-agent execution** — Leader breaks tasks into subtasks and delegates to Teammate agents running in parallel; each Teammate uses its own model via ACP (Agent Communication Protocol, AURA's multi-agent coordination layer), Gemini, or Aionrs
- **Leader orchestration** — Leader assigns, tracks, and aggregates results; supported backends include Claude Code, Codex, Hermes Agent, Gemini, Snow CLI, and AURA CLI
...
- **Supported backends** — Claude Code, Codex, Gemini, Snow CLI, AURA CLI (aionrs); other ACP backends with `mcpCapabilities.stdio` are auto-supported
...
Other AI apps give you a chatbox with your API key. **AURA gives you a full Cowork agent.**
...
| AWS Bedrock credentials    | Bedrock-powered Agent via AURA CLI (aionrs) |
| Ollama / LM Studio (local) | Local model Cowork Agent                    |
| NewAPI Gateway             | Unified access to 20+ models                |

Same agent capabilities — file read/write, web search, image generation, tool use — regardless of which model powers it. AURA supports **30+ AI platforms** including cloud services and local deployments.
...
AURA also supports [NewAPI](https://github.com/QuantumNous/new-api) gateway service — a unified AI model hub that aggregates and distributes various LLMs. Flexibly switch between different models in the same interface to meet various task requirements.
...
- **Three-tier Skills** — Builtin skills (shipped with AURA), custom skills (your own), and Extension skills (contributed by third-party extensions); enable/disable per conversation with the skill indicator
...
AURA supports three skill layers: **built-in** skills (shipped with the app), **custom** skills (user-defined), and **extension** skills (loaded from the Extension SDK).
...
AURA includes **21 professional assistants** with predefined capabilities, extendable through custom skills:
...
**Custom Skills**: Create skills in the `skills/` directory, enable/disable skills for assistants to extend AI capabilities. Skills come from three sources: builtin (shipped with AURA), custom (your own), and Extension (contributed via the Extension SDK). Built-in skills include `pptx`, `docx`, `pdf`, `xlsx`, `mermaid`, and more.
...
_Your 24/7 AI assistant — access AURA from any device, anywhere._
...
> **Setup:** AURA Settings → WebUI Settings → Channel, configure the Bot Token.
...
> [Remote Internet Access Tutorial](https://github.com/iOfficeAI/AURA/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Keep-awake** — AURA automatically prevents system sleep while tasks are active, and detects missed triggers after wake
...
> [Image generation model configuration guide](https://github.com/iOfficeAI/AURA/wiki/AURA-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Why Choose AURA Over Claude Cowork?
...
A: <strong>No.</strong> AURA has a built-in AI agent that works immediately after installation. Just enter any API key to get started. If you also have CLI tools like Claude Code or Gemini CLI installed, AURA will auto-detect and integrate them for even more capabilities.
</details>

<details>
<summary><strong>Q: What can I do with AURA?</strong></summary>
A: AURA is your <strong>private Cowork workspace</strong>. The built-in agent can batch organize folders, process Excel data, generate documents, search the web, and generate images. With Multi-Agent Mode, you can also leverage Claude Code, Codex, and other powerful CLI agents through the same interface.
</details>

<details>
<summary><strong>Q: Is it free?</strong></summary>
A: AURA is completely free and open source. You only pay for the API usage of whichever provider you choose, and you can use API keys from any provider you prefer.
</details>

<details>
<summary><strong>Q: Can I run AURA on a server (headless)?</strong></summary>
A: Yes — AURA WebUI mode runs as a standalone HTTP server. See the WebUI section above for setup instructions.
</details>
...
> **Made a video about AURA?** [Let us know on X](https://x.com/AURA) and we'll feature it here!
...
- [📖 Complete Installation Guide](https://github.com/iOfficeAI/AURA/wiki/Getting-Started) — Detailed steps from download to configuration
- [⚙️ LLM Configuration Guide](https://github.com/iOfficeAI/AURA/wiki/LLM-Configuration) — Multi-platform AI model configuration
- [🤖 Multi-Agent Mode Setup](https://github.com/iOfficeAI/AURA/wiki/ACP-Setup) — Integrate terminal AI agents
- [🔌 MCP Tool Configuration](https://github.com/iOfficeAI/AURA/wiki/MCP-Configuration-Guide) — Model Context Protocol server setup
- [🌐 WebUI Configuration Guide](https://github.com/iOfficeAI/AURA/wiki/WebUI-Configuration-Guide) — Complete WebUI setup and configuration tutorial

**🎯 Use Cases**

- [📁 File Management](https://github.com/iOfficeAI/AURA/wiki/file-management) — Smart file organization
- [📊 Excel Processing](https://github.com/iOfficeAI/AURA/wiki/excel-processing) — AI-driven data processing
- [🎨 Image Generation](https://github.com/iOfficeAI/AURA/wiki/AURA-Image-Generation-Tool-Model-Configuration-Guide) — AI image creation
- [📚 More Use Cases](https://github.com/iOfficeAI/AURA/wiki/Use-Cases-Overview)

**❓ Support & Help**

- [❓ FAQ](https://github.com/iOfficeAI/AURA/wiki/FAQ) — Questions and troubleshooting
- [🔧 Configuration & Usage Tutorials](https://github.com/iOfficeAI/AURA/wiki/Configuration-Guides) — Complete configuration documentation
...
- [GitHub Discussions](https://github.com/iOfficeAI/AURA/discussions) — share ideas and exchange tips
- [Report Issues](https://github.com/iOfficeAI/AURA/issues) — bugs and feature requests
- [Release Updates](https://github.com/iOfficeAI/AURA/releases) — get the latest version
...
AURA local development uses two repositories: AURA for the Electron frontend and AionCore for the local backend. See the [Development Guide](docs/contributing/development.md) for the full macOS, Linux, and Windows setup.
...
[Report Bug](https://github.com/iOfficeAI/AURA/issues) · [Request Feature](https://github.com/iOfficeAI/AURA/issues)
