...
preflight:
    ...
    $failed = $false
    Write-Host "=========================================="
    Write-Host "  AURAUI Build Preflight Check"
    Write-Host "=========================================="
    Write-Host ""
...
build-win: preflight
    ...
    Get-Process -Name "AURAUI","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue
