...
describe('MarkdownView local file links', () => {
  ...
  it('renders local file links as app controls instead of browser anchors', () => {
    ...
    render(
      <MarkdownView onLocalFileLink={onLocalFileLink}>
        {'[report.xlsx](/C:/Users/Administrator/AppData/Roaming/AURA/report.xlsx)'}
      </MarkdownView>
    );
    ...
    expect(onLocalFileLink).toHaveBeenCalledWith(
      'C:/Users/Administrator/AppData/Roaming/AURA/report.xlsx',
      expect.objectContaining({
        filePath: 'C:/Users/Administrator/AppData/Roaming/AURA/report.xlsx',
      })
    );

    fireEvent.click(screen.getByRole('button', { name: 'Copy' }));
    expect(copyTextMock).toHaveBeenCalledWith('C:/Users/Administrator/AppData/Roaming/AURA/report.xlsx');
  });
  ...
  it('renders line references as file chips and copies the full reference', () => {
    ...
    render(
      <MarkdownView onLocalFileLink={onLocalFileLink}>
        {'[2026-06-19.log](C:/Users/Administrator/AppData/Roaming/AURA/logs/2026-06-19.log:1421)'}
      </MarkdownView>
    );
    ...
    expect(onLocalFileLink).toHaveBeenCalledWith(
      'C:/Users/Administrator/AppData/Roaming/AURA/logs/2026-06-19.log',
      expect.objectContaining({
        filePath: 'C:/Users/Administrator/AppData/Roaming/AURA/logs/2026-06-19.log',
        rawReference: 'C:/Users/Administrator/AppData/Roaming/AURA/logs/2026-06-19.log:1421',
        line: 1421,
      })
    );

    fireEvent.click(screen.getByRole('button', { name: 'Copy' }));
    expect(copyTextMock).toHaveBeenCalledWith('C:/Users/Administrator/AppData/Roaming/AURA/logs/2026-06-19.log:1421');
  });
  ...
  it('renders line and column references as file chips and copies the full reference', () => {
    ...
    render(
      <MarkdownView onLocalFileLink={onLocalFileLink}>
        {'[app.log](C:/Users/Administrator/AppData/Roaming/AURA/logs/app.log:1421:7)'}
      </MarkdownView>
    );
    ...
    expect(onLocalFileLink).toHaveBeenCalledWith(
      'C:/Users/Administrator/AppData/Roaming/AURA/logs/app.log',
      expect.objectContaining({
        filePath: 'C:/Users/Administrator/AppData/Roaming/AURA/logs/app.log',
        rawReference: 'C:/Users/Administrator/AppData/Roaming/AURA/logs/app.log:1421:7',
        line: 1421,
        column: 7,
      })
    );
    ...
    fireEvent.click(screen.getByRole('button', { name: 'Copy' }));
    expect(copyTextMock).toHaveBeenCalledWith('C:/Users/Administrator/AppData/Roaming/AURA/logs/app.log:1421:7');
  });
  ...
  it('does not render a no-op open button when no local file handler is provided', () => {
    render(<MarkdownView>{'[report.xlsx](/C:/Users/Administrator/AppData/Roaming/AURA/report.xlsx)'}</MarkdownView>);
  ...
  it('keeps ordinary http links as browser anchors', () => {
    render(<MarkdownView>{'[docs](https://aura.com/docs)'}</MarkdownView>);

    const link = screen.getByRole('link', { name: 'docs' });
    expect(link).toHaveAttribute('href', 'https://aura.com/docs');
  });

  it('keeps http hash links as browser anchors', () => {
    render(<MarkdownView>{'[docs](https://aura.com/docs#L10)'}</MarkdownView>);

    const link = screen.getByRole('link', { name: 'docs' });
    expect(link).toHaveAttribute('href', 'https://aura.com/docs#L10');
  });
});
