...
describe('TeamCreateModal', () => {
  ...
  it('keeps blocked assistants visible with a reason and prevents selecting them', () => {
    ...
    expect(screen.getByText('AURA 命令行')).toBeInTheDocument();
    expect(screen.queryByText('AURA CLI')).not.toBeInTheDocument();
