...
describe('storage runtime exports', () => {
  ...
  describe('EnvStorage', () => {
    ...
    it('set/get roundtrip with aura.dir object', async () => {
      const dirs = {
        workDir: '/a',
        cacheDir: '/b',
        dataDir: '/c',
      ...
      await EnvStorage.set('aura.dir', dirs);
      const result = await EnvStorage.get('aura.dir');
  ...
  describe('storage isolation', () => {
    it('ConfigStorage and EnvStorage do not share state', async () => {
      ...
      const envDir = await EnvStorage.get('aura.dir');
