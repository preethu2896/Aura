 ...
 * 会话来源类型 - 标识会话创建的来源
 */
export type ConversationSource = 'aura' | 'telegram' | 'lark' | 'dingtalk' | 'weixin' | 'wecom' | (string & {});
...
interface IChatConversation<T, Extra> {
  ...
  /** 会话来源，默认为 aura / Conversation source, defaults to aura */
...
export type TChatConversation =
  ...
  // AionCore/crates/aura-common/src/enums.rs and factory.rs.
...
export interface IMcpServer {
  ...
  /** Built-in MCP server managed by AURA (hide edit/delete in UI) */
  builtin?: boolean;
}
...
export const BUILTIN_IMAGE_GEN_NAME = 'aura-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['AURA Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
