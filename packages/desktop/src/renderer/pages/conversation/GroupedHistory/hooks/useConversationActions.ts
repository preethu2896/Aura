...
export const useConversationActions = ({
  ...
  /**
   * Remove project state — rendered via AURAModal in the GroupedHistory component.
   * Uses project's design system: AURAModal component with danger-styled action button.
   */
