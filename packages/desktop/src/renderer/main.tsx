  ...
  void import('@sentry/electron/renderer')
    .then((Sentry) => {
      Sentry.withScope((scope) => {
        scope.setTag('aura.installation_integrity', event.failure_kind ?? 'unknown');
        scope.setTag('aura.runtime_resource', event.resource);
        scope.setTag('aura.runtime_resource_id', event.resource_id ?? '');
        scope.setTag('aura.runtime_scope', event.scope.kind);
