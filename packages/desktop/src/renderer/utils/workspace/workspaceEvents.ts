export const WORKSPACE_TOGGLE_EVENT = 'aura-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'aura-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'aura-workspace-has-files';
