 ...
 * <AURAScrollArea className="h-400px">
 *   <div>Content...</div>
 * </AURAScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <AURAScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </AURAScrollArea>
 *
 * // 双向滚动 / Both directions
 * <AURAScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </AURAScrollArea>
 * ```
 */
interface AURAScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const AURAScrollArea: React.FC<AURAScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
AURAScrollArea.displayName = 'AURAScrollArea';
