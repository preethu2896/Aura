...
type AURASelectSize = NativeSelectSize | 'middle';

export interface AURASelectProps extends NativeSelectProps {
...
/**
 * 基础样式类名
 * 注意：主题相关样式（背景色、边框色）在 arco-override.css 的 .aura-select 类中定义
 * Note: Theme-related styles (background, border colors) are defined in .aura-select class in arco-override.css
 */
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <AURASelect placeholder="请选择" style={{ width: 200 }}>
 *   <AURASelect.Option value="1">选项1</AURASelect.Option>
 *   <AURASelect.Option value="2">选项2</AURASelect.Option>
 * </AURASelect>
 *
 * // 多选 / Multiple selection
 * <AURASelect mode="multiple" placeholder="请选择多个">
 *   <AURASelect.Option value="1">选项1</AURASelect.Option>
 *   <AURASelect.Option value="2">选项2</AURASelect.Option>
 * </AURASelect>
 *
 * // 分组 / Grouped options
 * <AURASelect placeholder="请选择">
 *   <AURASelect.OptGroup label="分组1">
 *     <AURASelect.Option value="1">选项1</AURASelect.Option>
 *   </AURASelect.OptGroup>
 *   <AURASelect.OptGroup label="分组2">
 *     <AURASelect.Option value="2">选项2</AURASelect.Option>
 *   </AURASelect.OptGroup>
 * </AURASelect>
 * ```
 *
 * @see arco-override.css for theme-related styles (.aura-select)
 */
const mapSizeToNative = (size?: AURASelectSize): NativeSelectSize | undefined => {
  if (!size) return undefined;
  if (size === 'middle') return 'default';
  return size;
};

type AURASelectComponent = React.ForwardRefExoticComponent<AURASelectProps & React.RefAttributes<SelectHandle>> & {
  Option: typeof Select.Option;
  OptGroup: typeof Select.OptGroup;
};

const InternalSelect = React.forwardRef<SelectHandle, AURASelectProps>(
...
const AURASelect = InternalSelect as AURASelectComponent;

AURASelect.displayName = 'AURASelect';

// 导出子组件 / Export sub-components
AURASelect.Option = Select.Option;
AURASelect.OptGroup = Select.OptGroup;
