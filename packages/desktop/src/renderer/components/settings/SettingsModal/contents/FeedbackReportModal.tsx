...
const FeedbackReportModal: React.FC<FeedbackReportModalProps> = ({
  ...
  // "Solve via chat": hand the report to the AURA Butler for on-the-spot
  ...
  return (
    <ModalWrapper
      ...
      // AURAModal (e.g. the Agent editor). Arco's default z-index stacks
