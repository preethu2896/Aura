        ...
        <>
          ...
          <Form layout='horizontal' labelAlign='left' className='space-y-12px'>
            <Form.Item label={t('settings.speechToTextSource')}>
              <AURASelect value={source} onChange={handleSourceChange}>
                <AURASelect.Option value='openai'>{t('settings.speechToTextSourceOpenAI')}</AURASelect.Option>
                <AURASelect.Option value='deepgram'>{t('settings.speechToTextSourceDeepgram')}</AURASelect.Option>
                <AURASelect.Option value='custom'>{t('settings.speechToTextSourceCustom')}</AURASelect.Option>
              </AURASelect>
            </Form.Item>
                  ...
                  const badgeText =
                    capability === 'supported'
                      ...
                      : capability === 'unsupported'
                        ...
                        : null;
                  return (
                    <AURASelect.Option key={model} value={model}>
                      {model}
            ...
            <Form.Item label={t('settings.speechToTextLanguage')}>
              <AURASelect value={activeLanguage} onChange={handleLanguageChange}>
                {SPEECH_LANGUAGE_OPTIONS.map((option) => (
                  <AURASelect.Option key={option.value || 'auto'} value={option.value}>
