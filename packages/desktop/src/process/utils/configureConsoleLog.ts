 ...
 *   - macOS:   ~/Library/Logs/AURA/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\AURA\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/AURA/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
