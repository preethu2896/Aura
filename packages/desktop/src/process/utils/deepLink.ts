...
export const PROTOCOL_SCHEME = 'aura';

/**
 * Parse an aura:// URL into action and params.
 * Supports two formats:
 *   1. aura://add-provider?base_url=xxx&api_key=xxx
 *   2. aura://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
